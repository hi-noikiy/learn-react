...
JSX is javascript sugar for reactjs. It is recommended being used in React to describe what the UI should look like.
...
The **state** is similar to **props**, but it is private and entirely controlled by the component of it.
...
A full example is <a href="../../src/components/Clock/index.js"> Clock Component</a>
...
Here is an in-depth explanation of <a href="https://reactjs.org/docs/reconciliation.html#recursing-on-children">why keys are necessary</a>   if you’re interested in learning more.
...
The **single responsibility principle**, that is, **a component should ideally do one thing**. If it ends up with growing, decompose it into smaller sub-components. (https://en.wikipedia.org/wiki/Single_responsibility_principle)

A detailed example is here: https://reactjs.org/docs/thinking-in-react.html